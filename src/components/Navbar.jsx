      ...
      <nav className="mx-auto w-full max-w-6xl px-5 py-4 sm:px-8">
        ...
        <ul className="hidden items-center gap-7 text-sm font-medium text-[color:var(--text-muted)] md:flex">
          ...
          <div className="flex items-center gap-3">
            <a
              href="/resume.pdf"
              className="hidden rounded-full border border-white/20 px-4 py-2 text-xs font-semibold tracking-wide text-[color:var(--text-strong)] transition-all duration-200 hover:-translate-y-0.5 hover:border-[color:var(--brand)] hover:bg-[color:var(--brand)] hover:text-[color:var(--surface)] md:inline-flex"
            >
              Resume
            </a>
            <button
              type="button"
              className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-white/20 text-[color:var(--text-strong)] md:hidden"
          ...
          <div className="mt-4 rounded-2xl border border-white/15 bg-white/5 p-4 md:hidden">
            <ul className="flex flex-col gap-2 text-sm font-medium text-[color:var(--text-muted)]">
              ...
              <li>
                <a
                  href="/resume.pdf"
                  className="mt-2 inline-flex rounded-full border border-white/20 px-4 py-2 text-xs font-semibold tracking-wide text-[color:var(--text-strong)] transition-all duration-200 hover:border-[color:var(--brand)] hover:bg-[color:var(--brand)] hover:text-[color:var(--surface)]"
                  onClick={handleNavClick}
                >
                  Resume
                </a>
